...
- Dark theme (already built in ARG Builder — keep it)
- Primary accent: Orange `#f97316` (existing) or shift to NexusAI brand purple/teal
- Typography: Clean sans-serif (Inter, Geist, or similar)
- Logo: "NexusAI" wordmark with connected-node icon suggesting multi-brand convergence
...
> **Headline:** 280 operational playbooks. Ready in 5 minutes.
>
...
1. **Multi-brand by design** — Not a workaround; the core architecture
2. **Operational, not generic** — Built for SOPs and playbooks, not blank pages
3. **AI that understands your ops** — Semantic search, writing assist, process Q&A
4. **Templates from real businesses** — 280+ docs from actual operations, not generic filler
...
- Not a Notion replacement (we don't do projects, databases, wikis-for-everything)
- Not a help desk / customer support tool (Document360 territory)
- Not a developer docs platform (GitBook/Docusaurus territory)
- Not a general AI writing tool (Jasper/Copy.ai territory)
...
├── /ops-core            → Open source (GitHub link, docs, self-host guide)
├── /pricing             → Unified pricing across products
├── /blog                → Content marketing (ops excellence, case studies)
