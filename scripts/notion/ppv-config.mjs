...
export const PIPELINES = [
  ...
  },
  {
    ...
    priority: "High",
    progress: 30,
    notes: "See ARG-Builder Product Hunt Launch Guide in Vault.",
  },
  {
...
export const VAULTS = [
  ...
  { name: "GTM Strategy (ARG-Builder)", category: "GTM", type: "Playbook", source: "docs-seed/Go-to-Market Strategy by ARG-Builder.md" },
  { name: "LinkedIn Content Calendar", category: "GTM", type: "Template", source: "docs-seed/ARG-Builder LinkedIn Content Calendar.md" },
  { name: "Product Hunt Launch Guide", category: "GTM", type: "Playbook", source: "docs-seed/ARG-Builder Product Hunt Launch Guide.md" },
