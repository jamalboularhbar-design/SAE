...
const BRANDING_KEYS = [
  ...
  { key: 'logo_url', label: 'Logo URL', placeholder: '/logo-mark.png', type: 'text', tab: 'assets' },
  { key: 'favicon_url', label: 'Favicon URL', placeholder: '/favicon-32.png', type: 'text', tab: 'assets' },
