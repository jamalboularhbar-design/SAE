# ARG-Builder: Search Discovery UX

## Executive Summary

This playbook provides the sales methodology, talk tracks, and execution playbook for **Search Discovery UX** across the ARG-Builder revenue team. It is part of the ARG-Builder operational library for **Sales** teams building and scaling a B2B SaaS platform.
...
|-----------|------------------|-------|
| Standardize search discovery ux practices | Documented process adopted by team | Sales lead |
