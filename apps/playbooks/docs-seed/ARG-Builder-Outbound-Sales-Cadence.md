# ARG-Builder: Outbound Sales Cadence

## Executive Summary

This playbook provides the sales methodology, talk tracks, and execution playbook for **Outbound Sales Cadence** across the ARG-Builder revenue team. It is part of the ARG-Builder operational library for **Sales** teams building and scaling a B2B SaaS platform.
...
|-----------|------------------|-------|
| Standardize outbound sales cadence practices | Documented process adopted by team | Sales lead |
