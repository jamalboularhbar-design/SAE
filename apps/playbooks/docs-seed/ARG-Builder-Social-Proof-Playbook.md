# ARG-Builder: Social Proof Playbook

## Executive Summary

This playbook outlines the marketing strategy, channel tactics, and measurement framework for **Social Proof Playbook** in the ARG-Builder GTM motion. It is part of the ARG-Builder operational library for **Marketing** teams building and scaling a B2B SaaS platform.
...
|-----------|------------------|-------|
| Standardize social proof playbook practices | Documented process adopted by team | Marketing lead |
