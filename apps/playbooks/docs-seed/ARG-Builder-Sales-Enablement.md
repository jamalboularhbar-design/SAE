# ARG-Builder: Sales Enablement

## Executive Summary

This playbook provides the sales methodology, talk tracks, and execution playbook for **Sales Enablement** across the ARG-Builder revenue team. It is part of the ARG-Builder operational library for **Sales** teams building and scaling a B2B SaaS platform.
...
|-----------|------------------|-------|
| Standardize sales enablement practices | Documented process adopted by team | Sales lead |
