...
const BRANDING_KEYS = [
  ...
  { key: 'logo_url', label: 'Logo URL', placeholder: '/logo-mark.svg', type: 'text', tab: 'assets' },
  { key: 'favicon_url', label: 'Favicon URL', placeholder: '/favicon.svg', type: 'text', tab: 'assets' },
