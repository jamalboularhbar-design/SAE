...
const GUEST_TIMELINE: TimelineEvent[] = [
  {
    ...
    description: 'Suite Deluxe, Grand Palace Hotel',
  ...
  },
  {
    ...
    type: 'stay',
    title: 'Checkout',
    description: 'Riverside Luxury Hotel (Suite Prestige)',
  ...
  },
  {
    ...
    description: 'Suite Prestige, Riverside Luxury Hotel',
  ...
  },
  {
    ...
    type: 'stay',
    title: 'Checkout',
    description: 'Vista Resort (Junior Suite)',
