...
const FAQS: FAQ[] = [
  ...
  // Pricing
  { category: 'pricing', question: 'What plans are available?', answer: 'One membership at $39/month, or Founding Member at $290/year (price locked, limited seats). Founding includes direct founder access and onboarding calls. Morocco-based companies can pay by invoice/virement — contact jamal@argbuilder.io.' },
  { category: 'pricing', question: 'Is there a free plan?', answer: 'The public library is browsable. Founding and membership tiers unlock full workspace access, AI hub, and Nexus OS. Book a demo to discuss founding access for your team.' },
  { category: 'pricing', question: 'Can I switch plans later?', answer: 'Yes — you can move between monthly membership and founding annual. Contact us for Morocco invoice billing.' },
  { category: 'pricing', question: 'Do you offer annual discounts?', answer: 'Founding Member is $290/year (~$24/mo equivalent) with the price locked permanently. Monthly membership is $39/mo with no long-term commitment.' },
  // Security
