...
const SAMPLE_ALERTS: Alert[] = [
  {
    ...
    description: 'Riverside Luxury Hotel SLA compliance dropped to 94% (target: 96%)',
    severity: 'high',
  ...
  },
  {
    ...
    description: 'Highland Retreat response time exceeded 35 minutes (target: 20 min)',
    severity: 'critical',
  ...
  },
  {
    ...
    description: 'Cedar Boutique Hotel guest satisfaction dropped 8 points to 78% (trend: ↓)',
    severity: 'high',
    provider: 'Cedar Boutique Hotel',
  ...
  },
  {
    ...
    description: 'Grand Palace Hotel approaching 95% occupancy for next 3 weeks',
    severity: 'medium',
