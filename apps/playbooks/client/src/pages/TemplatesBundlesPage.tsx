...
import {
  ArrowRight, ArrowLeft, Package, CheckCircle2, Sparkles, Download, Layers,
} from "lucide-react";
      ...
      <main className="pt-24 pb-20 px-4">
        <div className="max-w-6xl mx-auto text-center mb-14">
          <Badge className="mb-4 bg-teal-500/20 text-teal-300 border-teal-500/30 hover:bg-teal-500/20">
            Phase 1 — Templates Marketplace
          </Badge>
          <h1 className="text-4xl sm:text-5xl font-bold mb-4">
            Operational playbooks you can <span className="text-teal-400">buy today</span>, run tomorrow
          </h1>
          <p className="text-lg text-gray-400 max-w-2xl mx-auto">
            Curated SOP bundles in Notion, Markdown, and Google Docs. Every purchase includes credit toward{" "}
            {BRAND.productName} — the live platform with AI, search, and multi-brand workspaces.
          </p>
        </div>
          ...
          {TEMPLATE_BUNDLES.map((bundle) => (
            ...
            >
              ...
              <Button
                ...
                onClick={() => handleNotify(bundle.id, bundle.name)}
                disabled={submitLead.isPending && notifiedBundle === bundle.id}
              >
                {notifiedBundle === bundle.id ? "You're on the list!" : "Notify me at launch"}
              </Button>
            </div>
          ))}
        </div>
        ...
        <div className="max-w-xl mx-auto mb-16">
          <p className="text-sm text-gray-400 text-center mb-3">Get notified when Gumroad checkout goes live:</p>
        ...
        <div className="max-w-3xl mx-auto mt-16 text-center">
          ...
          <p className="text-gray-400 mb-6">
            Import into {BRAND.productName} and unlock {BRAND.aiHubTitle} — writing, search, chat, and summarizer on your docs.
          </p>
